...
export default function LegalPage() {
  return (
    <main className="min-h-screen bg-[#09090b] text-white p-6 md:p-20 font-sans">
      <Link href="/">
        <button className="mb-10 text-emerald-500 font-black uppercase tracking-widest text-xs hover:underline">
          ← Volver al Inicio
        </button>
      </Link>
      ...
      <div className="max-w-3xl mx-auto space-y-16">
        <section>
          <h1 className="text-4xl font-black italic uppercase mb-8 text-emerald-500">Términos y Condiciones</h1>
        ...
        <section>
          <h1 className="text-4xl font-black italic uppercase mb-8 text-emerald-500">Política de Privacidad</h1>
          <div className="space-y-4 text-zinc-400 text-sm leading-relaxed">
